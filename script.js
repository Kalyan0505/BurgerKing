...
btn.addEventListener("click", async function (e) {
  ...
  if (burger.checked) {
    ...
    images.push("./assets/burger.avif"); // Image file path for burger
  }
  if (fries.checked) {
    selectedItems.push(fries.id);
    images.push("./assets/friese.jpg"); // Image file path for fries
  }
  if (drink.checked) {
    selectedItems.push(drink.id);
    images.push("./assets/drink.jpg"); // Image file path for drink
  }
  ...
  inform_user.innerText = `Your order for ${selectedItems.join(
    " and "
  )} has been placed!!!`;
  ...
  setTimeout(() => {
    message.innerText = `Enjoy your ${selectedItems.join(
      " and "
